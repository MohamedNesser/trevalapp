import 'package:login_form/Models/Gatogry.dart';
import  'Models/Tripes.dart';
import 'package:login_form/Models/Tripes.dart';
...
const Trips_data = const [
  Trip(
    ...
    title: 'جبال الألب',
    tripType: TripeType.Exploration,
